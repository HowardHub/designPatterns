 ...
 * @Date 2021/1/8 15:26
 **/
public class SingletonStaticInnerClassThreadSafe5 {

    private static class SingletonHolder{
        private static final SingletonStaticInnerClassThreadSafe5 instance = new SingletonStaticInnerClassThreadSafe5();
    }

    private SingletonStaticInnerClassThreadSafe5(){}


    public static final SingletonStaticInnerClassThreadSafe5 getInstance(){
